...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ 2hand Store" title="Trang chủ 2hand Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">2Hand Shop</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Bảo Hà</span></p>
    </div>`);
}
